...
ALTER TABLE patient_diagnoses ADD COLUMN IF NOT EXISTS health_center_id BIGINT;
...
ALTER TABLE patient_treatments ADD COLUMN IF NOT EXISTS health_center_id BIGINT;
...
ALTER TABLE patient_medical_appointments ADD COLUMN IF NOT EXISTS health_center_id BIGINT;
